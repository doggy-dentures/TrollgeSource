...
class CpuStrums extends Option
{
	...
	private override function updateDisplay():String
	{
		return  FlxG.save.data.cpuStrums ? "CPUのアローが点灯する" : "CPUのアローが点灯しない";
	}
...
class PhotosensitiveOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return "光過敏性の考慮が" + (!FlxG.save.data.photosensitive ? "ない" : "ある");
	}
}
...
class Judgement extends Option
{
	...
	override function getValue():String {
		return "セーフフレーム: " + Conductor.safeFrames +
...
class FPSCapOption extends Option
{
	...
	override function getValue():String
	{
		return "フレームレート限界: " + FlxG.save.data.fpsCap + 
...
class ScrollSpeedOption extends Option
{
	...
	override function getValue():String {
		return "アローの速さ: " + HelperFunctions.truncateFloat(FlxG.save.data.scrollSpeed,1);
	}
